return {
	...
	overrides = {
		...
		start_location="tropicalexperience", 	-- "caves", "default", "plus", "darkness"
		...
		earthquakes = "never", 		    -- "never", "rare", "default", "often", "always"
		...
		petrification = "none", 		-- "none", "few", "default", "many", "max"
		...
		rock_ice = "never", 			-- "never", "rare", "default", "often", "always"
		...
		hunt = "never", 				-- "never", "rare", "default", "often", "always"
